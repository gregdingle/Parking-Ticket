...
from tgis.forms import signupForm, addressForm
...
def getLaw():
	...
	cursor.execute("select violation, violation_description as description, fine_amt,split_part(location, ' ', 2) AS street,ROUND(MAX(ST_Distance_Sphere(geopoint,ST_SetSRID(ST_Point(-122.426308, 37.757577), 4269)))) AS meters from tickets where ST_DWithin(geopoint, ST_SetSRID(ST_Point(-122.426308, 37.757577), 4269), 0.0005) group by violation, violation_description, fine_amt, street")
